  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
      ...
      .col-md-12.col-lg-12
        ...
        .align-items-center.justify-content-star.mb-2
          .div(data-aos="fade-left")
            h3.subtitle.position-relative Objetivos de la evaluación
    ...
    .row.justify-content-center.align-items-center.mb-5(data-aos="fade-left")
      ...
      .col-lg-3
        .crd_02.mb-5
          .crd_02__icon.dan
            img(src="@/assets/curso/temas/tema1/img04.svg", alt="alt")          
          .crd_02__txt
    ...
    .row.justify-content-center.align-items-center
      .col-md-12.col-lg-12
        ...
        .align-items-center.justify-content-star.mb-2
          .div(data-aos="fade-left")
            h3.subtitle.position-relative Tipos de evaluación
              img.image(src='@/assets/curso/temas/tema1/icon_subt.svg', alt='Imagen decorativa')
    ...
    .row.justify-content-center.align-items-stretch(data-aos="fade-right")
      .col-xl-7
        .row.justify-content-center.align-items-center.mb-5.fnd-3.fnd-3-1
          ...
          .col-lg-4.col-md-10
            figure.fl-box-img
              img.img-297(src='@/assets/curso/temas/tema1/img09.svg' alt='Background Image')
      .col-xl-5
        .row.justify-content-center.align-items-center.mb-3.fnd-3.fnd-3-2
          ...
          .col-xl-5.col-lg-4.col-md-10
            figure.fl-box-img             
              img.img-297(src='@/assets/curso/temas/tema1/img10.svg' alt='Background Image')
    ...
    .row.justify-content-center.align-items-center.mb-5(data-aos="fade-left")
      .col-lg-3.mb-5.mb-lg-0.col-md-8
        figure 
    ...
    .row.justify-content-center.align-items-center.mb-3
      .col-md-12.col-lg-12
        ...
        .align-items-center.justify-content-star.mb-2
          .div(data-aos="fade-left")
            h3.subtitle.position-relative Indicadores financieros para evaluar proyectos
              img.image(src='@/assets/curso/temas/tema1/icon_subt.svg', alt='Imagen decorativa')
    ...
    .row.justify-content-center.align-items-center.mb-3
      .col-md-12.col-lg-12
        ...
        .align-items-center.justify-content-star.mb-2
          .div(data-aos="fade-left")
            h3.subtitle.position-relative Valor Actual Neto o Valor Presente Neto (VAN)
              img.image(src='@/assets/curso/temas/tema1/icon_subt.svg', alt='Imagen decorativa')
    ...
    .row.justify-content-center.align-items-center.mb-3
      .col-md-12.col-lg-12
        ...
        .align-items-center.justify-content-star.mb-2
          .div(data-aos="fade-left")
            h3.subtitle.position-relative Tasa Interna de Retorno (TIR)
              img.image(src='@/assets/curso/temas/tema1/icon_subt.svg', alt='Imagen decorativa')
    ...
    .row.justify-content-center.align-items-center.mb-3
      .col-md-12.col-lg-12
        ...
        .align-items-center.justify-content-star.mb-2
          .div(data-aos="fade-left")
            h3.subtitle.position-relative ¿Cómo calcular la Tasa Interna de Retorno? 
              img.image(src='@/assets/curso/temas/tema1/icon_subt.svg', alt='Imagen decorativa')

    .bg-fondo-6.tarjeta.mb-5(data-aos="fade-left")
      .p-3.px-lg-4
        SlyderA(tipo="b").bg-color-white.p-3.p-lg-4.tarjeta
          .row.justify-content-center.align-items-center.p-4
            .col-lg-5.mb-4.mb-lg-0
            ...
            .col-md-8.col-lg-7.mb-0.mb-lg-0
              figure
                img(src='@/assets/curso/temas/tema1/img25.png', alt='El paso a seguir para calcular la tasa interna de retorno, primero se deben pasar los datos al archivo de Excel.')
          .row.justify-content-center.align-items-center
            .col-lg-5.mb-4.mb-lg-0
              h5 Paso 2
          ...
          .row.justify-content-center.align-items-center
            ...
            .col-md-8.col-lg-7.mb-0.mb-lg-0
              figure
                img(src='@/assets/curso/temas/tema1/img28.png', alt='En esta figura se ilustra la celda valores, se deben seleccionar los flujos netos incluyendo el periodo 0.')
          .row.justify-content-center.align-items-center
            .col-lg-5.mb-4.mb-lg-0
              h5 Paso 5
      ...
      .col-lg-12
        .row
          .col-xl-8
            ...
            .tabla-b.color-acento-contenido.mb-3.ttbl4
              table
                
                tr
                  th.t1.text-bold.not_border(colspan='4') Flujo de caja
                tr
                  th.t2 Periodo
                  th.t2 Inversión
                  th.t3 Ingresos
